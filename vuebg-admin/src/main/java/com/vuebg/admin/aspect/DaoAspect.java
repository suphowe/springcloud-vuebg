package com.vuebg.admin.aspect;

import java.util.Date;

import javax.servlet.http.HttpServletRequest;

import com.vuebg.admin.utils.SecurityUtils;
import com.vuebg.admin.utils.StringUtils;
...
public class DaoAspect {
    ...
    //定义切点
    @Pointcut("execution(* com.vuebg.*.dao.*.update*(..))")
    public void daoUpdate() {
    }

    @Pointcut("execution(* com.vuebg.*.dao.*.insert*(..))")
