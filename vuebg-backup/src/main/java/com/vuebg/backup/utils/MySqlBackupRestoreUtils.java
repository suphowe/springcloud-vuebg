package com.vuebg.backup.utils;
...
public class MySqlBackupRestoreUtils {
    ...
    /**
     * 备份数据库
     * @param OSType 服务器系统 Linux,Windows
     ...
     * @throws IOException
     */
    public static boolean backup(String OSType, String host, String userName, String password, String backupFolderPath, String fileName,
    ...
    public static void main(String[] args) throws Exception {
        String host = "192.168.200.112";
        String userName = "root";
        String password = "root";
        String database = "suphowe";

        System.out.println("开始备份");
        String backupFolderPath = "/home/tjtl/share/";
        String fileName = "suphowe.sql";
        backup("Linux", host, userName, password, backupFolderPath, fileName, database);
        System.out.println("备份成功");

//        System.out.println("开始还原");
//        String restoreFilePath = "c:/dev/suphowe.sql";
