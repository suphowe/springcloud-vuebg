package com.vuebg.backup.controller;


import com.vuebg.backup.constants.BackupConstants;
import com.vuebg.backup.datasource.BackupDataSourceProperties;
import com.vuebg.backup.service.IMysqlBackupService;
import com.vuebg.backup.utils.FileUtils;
import com.vuebg.backup.utils.HttpResult;
...
public class MySqlBackupController {
    ...
    @Autowired
    IMysqlBackupService mysqlBackupService;
    @Autowired
